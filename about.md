...
- **`apps/mobile`**: aplicación móvil multiplataforma en Flutter (iOS/Android) con Riverpod, GoRouter, Dio, WebSocket con reconexión automática y contratos compartidos sincronizados.
