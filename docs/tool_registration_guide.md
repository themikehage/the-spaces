...
Esta guía explica paso a paso los archivos del monorepo que deben modificarse para registrar y habilitar una nueva herramienta (_tool_) desde el backend hasta el frontend.
