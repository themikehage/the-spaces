...
El plan dice literalmente: *"Rutas que NO migran en este hito: `/teams`, `/schedules`, `/approvals`, `/mcp`, `/backup`, `/preview`, `/files`, `/gallery`"*. De estas, 4 no son retomadas en ningún hito posterior:
...
*Reporte generado a partir del análisis de ~68 archivos del servidor, ~170 archivos del cliente, y las 3 fuentes de planificación (about.md, PLAN.md, 15-core-architecture-migration.md).*
