...
El `04` es un plan de _capacidades nuevas_. No es un plan de calidad del código existente.
...
`steps.md` tiene pendiente: _"Definir comandos estándar para typecheck, lint y pruebas en todos los workspaces"_.
...
`steps.md` tiene pendiente: _"Documentar variables de entorno, persistencia local y procedimiento de despliegue"_.
...
Una vez que el SDK existe y el plugin API funciona, la pregunta cambia de _"¿cómo lo construimos?"_ a _"¿cómo llega a otros?"_.
