...
const QWEN_IMAGE_MODELS = [
  {
    ...
    provider: "qwen",
    description:
      "Supports text to image, text/image to sequential images, image editing, multi-image reference generation, and interactive editing. Delivers enhanced performance in text rendering, subject consistency, and complex instruction following.",
    cost: 0.075,
    rpm: 300,
    concurrency: 5,
  },
  ...
  },
  {
    ...
    provider: "qwen",
    description:
      "The Max series of Qwen’s image editing models delivers more stable and versatile editing capabilities: enhanced industrial design and geometric reasoning, improved character consistency, reduced offset issues, and integrated LoRA capabilities for a wider range of image editing functions.",
    cost: 0.075,
    rpm: 2,
    concurrency: null,
  },
  ...
  },
  {
    ...
    provider: "qwen",
    description:
      "The Qwen series of Image Editing Plus models features enhanced character consistency, industrial design capabilities, and geometric reasoning abilities compared to the snapshot as of October 30. Additionally, it integrates LoRA capabilities such as lighting effects and effectively mitigates offset issues. This version is based on a snapshot taken on December 15, 2025.",
    cost: 0.03,
    rpm: 120,
    concurrency: null,
  },
...
modelsRouter.get("/images", authMiddleware, (c) => {
  ...
  const hasOpenRouter =
    authStorage.hasAuth("openrouter") ||
