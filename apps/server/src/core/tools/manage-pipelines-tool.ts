    ...
    parameters: {
      ...
      properties: {
        ...
        id: {
          type: "string",
          description:
            "The pipeline ID. Required for all actions except 'get' when listing all pipelines. For get runs/detail, format id as 'pipeline-id/runs' or 'pipeline-id/runs/run-id'.",
        },
        params: {
          type: "object",
          description:
