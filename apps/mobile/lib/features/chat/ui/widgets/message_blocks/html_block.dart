...
class HtmlBlockWidget extends StatefulWidget {
  final String html;
  final String? title;

  const HtmlBlockWidget({
    super.key,
    required this.html,
    this.title,
  });
  ...
  @override
  State<HtmlBlockWidget> createState() => _HtmlBlockWidgetState();
}

class _HtmlBlockWidgetState extends State<HtmlBlockWidget> {
  bool _showRaw = false;
